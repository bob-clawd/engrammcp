...
public sealed class StoreShortTermTool(IMemoryService memoryService) : Tool
{
    ...
    [Description("Use this tool for the recent working state you want available next session - such as completed tasks, milestones, touched files, and the active workspace area. Capacity: 10 memories. FIFO.")]
